      ...
      <div className="relative z-10 min-h-screen flex items-center">
        <div className="section-container w-full">
          <div className="max-w-3xl mx-auto text-center">
            ...
            {/* Subtitle */}
            <p className="hero-subtitle text-base md:text-lg text-white/80 mt-6 max-w-xl mx-auto leading-relaxed">
              {t("subtitle")}
            </p>
            ...
            <div className="hero-buttons flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <MagneticButton>
                <Link 
                  href="#contact" 
                  onClick={() => trackEvent("click_primary_cta", { target: "hero_strategic_consultation" })}
                  className="btn-primary text-base relative group"
                >
              ...
              <MagneticButton strength={0.2}>
                <Link 
                  href="#process" 
                  onClick={() => trackEvent("click_primary_cta", { target: "hero_learn_more" })}
            ...
            {/* Social Proof */}
            <p className="hero-badge mt-6 text-white/70 text-sm flex items-center justify-center gap-2">
