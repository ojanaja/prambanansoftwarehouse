...
interface SpecializedSolutionItem {
  title: string;
  desc: string;
}
...
export default function SpecializedSolutionsSection() {
  ...
  const govServices = t.raw("govServices") as SpecializedSolutionItem[];
  const eduServices = t.raw("eduServices") as SpecializedSolutionItem[];
