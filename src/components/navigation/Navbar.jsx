            ...
            >
              ...
              <ul className="flex flex-row items-center gap-2 p-2">
                <li>
                  <a
                    href="/"
                    className="px-3 backdrop:blur-md hover:backdrop:blur-lg py-3 hover:transparent  hover:bg-slate-100 ease-in-out rounded-full transition-all cursor-pointer"
                  >
                    Home
                  </a>
                </li>
